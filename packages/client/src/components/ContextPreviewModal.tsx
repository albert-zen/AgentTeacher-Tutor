                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2.5">
                          ...
                          {sourceLabel && (
                            <span className="text-[11px] text-zinc-500">{sourceLabel}</span>
                          )}
                        </div>
                  ...
                  {expanded && (
                    <div className="space-y-4 border-t border-zinc-800 px-4 py-4">
                      ...
                      {section.kind === 'tool_instructions' && section.meta?.tools && (
                        <div className="space-y-3">
                          {section.meta.tools.map((tool) => (
                            <div
                              key={tool.id}
                              className="rounded-xl border border-zinc-800 bg-zinc-950/80 px-4 py-3"
                            >
                      ...
                      {section.kind === 'history_turn' && section.meta?.parts && section.meta.parts.length > 0 && (
                        <div className="space-y-3">
                          <div className="text-[11px] uppercase tracking-[0.18em] text-zinc-500">过程</div>
